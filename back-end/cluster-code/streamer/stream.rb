...
###MANAGEMENT UTILITIES###
  ...
  def update_datasets(datasets)
    ...
    finished_datasets = Dataset.find_all({:scrape_finished => true, :instance_id => $w.instance_id, :scrape_type => ["Search", "Trend"]})
    Database.update_attributes(:datasets, finished_datasets, {"instance_id" => ""}) if !finished_datasets.empty?
