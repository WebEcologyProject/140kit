...
ActiveRecord::Schema.define(:version => 20100716221216) do
  ...
  create_table "scrapes", :force => true do |t|
    ...
    t.string   "humanized_length",                                           :null => false
  ...
  create_table "users", :force => true do |t|
    ...
    t.string   "profile_background_image_url",                                 :null => false
    t.boolean  "profile_background_tile",      :default => false,              :null => false
    ...
    t.integer  "scrape_id",                    :default => 0,                  :null => false
    t.boolean  "contributors_enabled",         :default => false,              :null => false
